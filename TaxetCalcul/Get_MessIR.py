...
#     # meassure the profile
#     px, py, prfl_angl = meassure_angles(morph_type, xfitl, yfitl)
#     print(prfl_angl)
#     axs[3].plot(px, py, 'o')
#     axs[3].plot(px, py, c='red')
#     plt.show


# def meassure_angles(morph_type, x, y):
#     peaks = peakdetect.peakdetect(y,x,lookahead=1, delta=0.0)
#     # peaks, _ = find_peaks(x,y)
#     higherPeaks = peaks[0]
#     lowerPeaks = peaks[1]
#     xs=[]
#     ys=[]
#     for p in higherPeaks:
#         xs.append(p[0])
#         ys.append(p[1])
#     for p in lowerPeaks:
#         xs.append(p[0])
...
#         prfl_angl.append(theta*180/np.pi)
#     # if not all the points are detected
#     return(xs, ys, prfl_angl)